...
const raw: Omit<Professional, 'slug'>[] = [
  // ── BUILDERS — mid-size real Australian companies ──
  {
    ...
    description: "Family-run Sydney builder specialising in knockdown rebuild and dual occupancy across the Hills District and Upper North Shore. Transparent fixed-price contracts with dedicated site supervisors for every KDR project.",
    website: null, wechat: null,
  },
  {
    name: 'Northline Constructions',
    category: 'builder', state: 'NSW',
    regions: ['Sydney', 'Central Coast', 'Wollongong'],
    specialties: ['Knockdown Rebuild', 'Dual Occupancy', 'Granny Flat'],
    verified: false, featured: false,
    description: 'Boutique NSW builder focused on knockdown rebuild and dual occupancy across Sydney western suburbs and Parramatta corridor. In-house drafting team and council liaison for streamlined DA approvals.',
    website: null, wechat: null,
  },
  {
    name: 'Ridgeline Building Group',
    ...
    verified: false, featured: false,
    description: 'SEQ-based builder with a strong focus on knockdown rebuild and character home replacement across Brisbane southside and Logan. Fixed-price contracts with dedicated project managers from design through to handover.',
    website: null, wechat: null,
  },
  {
    name: 'Bayside Building Co',
    ...
    verified: false, featured: false,
    description: 'Melbourne-based residential builder covering inner south-east to Geelong and regional VIC. Specialises in knockdown rebuild on compact lots, extensions, and custom homes with a hands-on owner-operator approach.',
    website: null, wechat: null,
  },
  {
    name: 'Steadfast Homes',
    category: 'builder', state: 'VIC',
    regions: ['Melbourne', 'Mornington Peninsula', 'Geelong'],
    specialties: ['Knockdown Rebuild', 'Display Homes', 'Custom Design'],
    verified: false, featured: false,
    description: 'Boutique Melbourne builder with a dedicated knockdown rebuild division covering inner suburbs through to the Mornington Peninsula. Known for quality inclusions and responsive site management.',
    website: null, wechat: null,
  },
  {
    name: 'Sandstone Edge Homes',
    ...
    verified: false, featured: false,
    description: 'Perth-based builder specialising in knockdown rebuild and custom homes across inner-city heritage precincts. Experienced with narrow-lot designs and R-Code compliant dual key projects.',
    website: null, wechat: null,
  },
  // ── BUILDING DESIGNERS ──
  {
  ...
  {
    name: 'Gateway Town Planning',
    category: 'planner', state: 'NSW',
    regions: ['Sydney', 'Central Coast', 'Wollongong'],
    specialties: ['DA Applications', 'Heritage', 'Rezoning', 'NCAT Appeals'],
    verified: false, featured: false,
    description: 'Small-practice town planners focused on residential DA applications, heritage overlays, and KDR feasibility across Greater Sydney and the Illawarra. Experienced with CDC and merit assessment pathways.',
    website: null, wechat: null,
  },
  {
