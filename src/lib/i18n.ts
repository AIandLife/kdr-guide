...
export const translations = {
  en: {
    ...
    home: {
      ...
      h1b: '& rebuild',
      h1c: 'your home?',
      subtitle: 'Enter your suburb and get an instant AI feasibility check — council rules, costs, timeline, and who to call. No consultant needed.',
      formSuburb: 'Your Suburb',
      formSuburbPlaceholder: 'e.g. Strathfield, Box Hill, Parramatta',
      formState: 'State',
      formStateAll: 'All States',
      ...
      painTitle: 'KDR is complicated. We make it clear.',
  ...
  zh: {
    ...
    home: {
      ...
      h1b: '推倒重建',
      h1c: '吗？',
      subtitle: '输入你的区，即刻获得 AI 可行性报告 — 政策规定、建筑费用、时间周期、该找谁。无需顾问。',
