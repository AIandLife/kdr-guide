...
export const SUPPLIERS: Supplier[] = [
  // ── WINDOWS & DOORS ──
  {
    ...
    states: ['NSW', 'QLD', 'ACT'],
    verified: true,
    verifiedNote: 'AGWA member, WERS energy rated products',
    googleRating: 4.3,
    googleReviews: 520,
  ...
  // ── FLOORING ──
  {
    ...
    descriptionZh: '澳洲最大的地板零售网络，拥有 200 家以上门店。提供地毯、木地板、乙烯基地板和强化地板全系列，以贸易价格深受住宅建筑商欢迎。',
    states: ['NSW', 'VIC', 'QLD', 'WA', 'SA', 'ACT', 'TAS', 'NT'],
    verified: true,
    verifiedNote: '50+ year operating history, national franchise network',
    googleRating: 4.2,
    googleReviews: 4800,
    website: 'carpetcourt.com.au',
    specialties: ['Carpet', 'Timber Flooring', 'Vinyl Plank', 'Trade Accounts', 'Installation'],
    specialtiesZh: ['地毯', '木地板', '乙烯基地板', '贸易账户', '安装服务'],
    featured: false,
    reliabilityScore: 84,
  },
  {
    ...
    verified: true,
    verifiedNote: 'Franchise network, FCIA member stores',
    googleRating: 4.4,
    googleReviews: 1200,
  ...
  // ── INSULATION (additional) ──
  {
    ...
    states: ['NSW', 'VIC', 'QLD', 'WA', 'SA', 'ACT', 'TAS', 'NT'],
    verified: true,
    verifiedNote: 'GreenStar certified materials, ABCB compliant',
    googleRating: 4.3,
    googleReviews: 380,
  ...
  // ── LANDSCAPING (additional) ──
  {
    ...
    descriptionZh: '澳洲领先的混凝土砌块制造商。提供铺路砖、挡土墙块、花园边缘和室外铺装，可在全国各地硬件和景观供应商处购买。',
    states: ['NSW', 'VIC', 'QLD', 'WA', 'SA', 'ACT', 'TAS'],
    verified: true,
    verifiedNote: 'ASX-listed company, 60+ year operating history',
    googleRating: 4.1,
    googleReviews: 890,
    website: 'adbri.com.au',
    specialties: ['Pavers', 'Retaining Walls', 'Garden Edging', 'Outdoor Paving', 'Concrete Blocks'],
    specialtiesZh: ['铺路砖', '挡土墙', '花园边缘', '室外铺装', '混凝土砌块'],
    featured: false,
    reliabilityScore: 82,
  },
  {
  ...
  // ── CURTAINS & BLINDS ──
  {
    ...
    verified: true,
    verifiedNote: 'Established Australian manufacturer with direct supply model',
    googleRating: 4.5,
    googleReviews: 620,
  ...
  },
  {
    ...
    descriptionZh: '澳洲最大的布料与家居零售商。提供成品及定制窗帘、透光帘、遮光内衬及窗帘轨道和杆，全国均有门店。',
    states: ['NSW', 'VIC', 'QLD', 'SA', 'WA', 'TAS', 'ACT', 'NT'],
    verified: true,
    verifiedNote: 'Major national retailer with 130+ Australian stores',
    googleRating: 4.1,
    googleReviews: 8400,
    website: 'spotlight.com.au',
    specialties: ['Ready-Made Curtains', 'Made-to-Measure', 'Curtain Tracks', 'Fabric by the Metre', 'Blockout Lining'],
    specialtiesZh: ['成品窗帘', '定制窗帘', '窗帘轨道', '布料零剪', '遮光内衬'],
    featured: false,
    reliabilityScore: 78,
  },
  {
  ...
  // ── CUSTOM WARDROBES ──
  {
    ...
    descriptionZh: '澳洲设计的平板包和半定制衣柜及橱柜品牌，适合推倒重建和翻新项目，可在Bunnings购买。提供多种饰面和尺寸配置。',
    states: ['NSW', 'VIC', 'QLD', 'SA', 'WA', 'TAS', 'ACT'],
    verified: true,
    verifiedNote: 'Established Australian brand distributed via Bunnings nationally',
    googleRating: 4.2,
    googleReviews: 1840,
    website: 'kinsman.com.au',
    specialties: ['Walk-in Wardrobes', 'Built-in Wardrobes', 'Sliding Doors', 'Laundry Storage', 'Home Office'],
    specialtiesZh: ['步入式衣帽间', '嵌入式衣柜', '滑门衣柜', '洗衣房储物', '家庭办公室'],
    featured: true,
    reliabilityScore: 85,
  },
  {
    ...
    states: ['NSW', 'VIC', 'QLD', 'SA', 'WA'],
    verified: true,
    verifiedNote: 'National custom wardrobe chain with strong builder relationships',
    googleRating: 4.4,
    googleReviews: 2100,
  ...
  },
  {
    ...
    descriptionZh: 'IKEA PAX模块化衣柜系统是推倒重建项目的热门经济选择。多种内部配置、柜门及饰面可选，提供自行安装或上门安装服务。',
    states: ['NSW', 'VIC', 'QLD', 'SA', 'WA', 'ACT'],
    verified: false,
    googleRating: 4.0,
    googleReviews: 12000,
    website: 'ikea.com/au',
    specialties: ['Modular Wardrobes', 'PAX System', 'Sliding Doors', 'Wardrobe Interiors', 'Budget-Friendly'],
    specialtiesZh: ['模块化衣柜', 'PAX系统', '滑门', '衣柜内配', '经济实惠'],
    featured: false,
    reliabilityScore: 72,
  },
  ...
  // ── OUTDOOR & PAVING ──
  {
    ...
    descriptionZh: '澳洲领先的混凝土铺路砖、挡土墙及庭院产品制造商。提供从经济型到高端的多种款式，可在Bunnings、Boral及独立景观供应商处购买。',
    states: ['NSW', 'VIC', 'QLD', 'SA', 'WA', 'TAS'],
    verified: true,
    verifiedNote: 'Major Australian manufacturer with national distribution',
    googleRating: 4.2,
    googleReviews: 760,
    website: 'adbrimasonry.com.au',
    specialties: ['Concrete Pavers', 'Retaining Walls', 'Garden Edging', 'Outdoor Tiles', 'Permeable Paving'],
    specialtiesZh: ['混凝土铺路砖', '挡土墙', '花园边框', '户外瓷砖', '透水铺装'],
    featured: false,
    reliabilityScore: 83,
  },
  {
    ...
    states: ['NSW', 'VIC', 'QLD', 'SA', 'WA'],
    verified: true,
    verifiedNote: 'Premium outdoor supplier with strong architect and builder relationships',
    googleRating: 4.6,
    googleReviews: 380,
