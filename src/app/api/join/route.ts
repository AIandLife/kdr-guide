...
export async function POST(req: Request) {
  ...
  try {
    ...
    const { businessName, contactName, email, phone, state, category, regions, website, description, abn, registrationCountry, businessNameEn, contactNameEn, descriptionEn } = body
